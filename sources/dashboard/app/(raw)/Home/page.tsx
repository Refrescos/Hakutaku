...
const data = [12, 19, 3, 5, 2, 3];
  ...
  const barColor = ''; // Cor das barras


const Home: React.FC = () => {

    const data = [5, 10, 15, 20, 25, 30];
    const labels = ['Categoria 1', 'Categoria 2', 'Categoria 5', 'Categoria 6'];
    const barColor = '#ED8936'; // Cor das barras
            ...
            <div className="flex flex-row min-w-full text-center min-h-full">
                ...
                <div className="flex-grow bg-white min-w-0">
                    ...
                    <div className='w-full flex flex-row px-20'>
                        ...
                        <BarChart data={data} labels={labels} barColor={barColor} barThickness={barThickness} />
                        </div>
                        <div className='w-2/3'>
                                ...
                                <table className="mt-4 w-full">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="p-2 border-b">120</td>
                                        </tr>
                                        <tr>
                                            <td className="p-2 border-b">API</td>
                                                <td className="p-2 border-b">Dados 5</td>
                                        ...
                                        <tr>
                                            ...
                                            <td className="p-2 border-b">90</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
